...
class BinaryCrossEntropy(LossFunction):
    """
    this class represents the cross entropy loss function.
    """

    def loss(self, y_true: np.ndarray, y_pred: np.ndarray) -> float:
        """
        this function computes the cross entropy loss function.
    ...
    def derivative(self, y_true: np.ndarray, y_pred: np.ndarray) -> np.ndarray:
        """
        this function computes the derivative of the cross entropy loss function.
        ...
        returns:
        numpy.ndarray -> The derivative of the loss function.
        """
        # Avoid division by zero
        p = np.clip(y_pred, 1e-15, 1 - 1e-15)
...
class CategoricalCrossEntropy(LossFunction):
    """
    this class represents cross entropy loss function.
    """
