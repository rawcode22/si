...
from si.src.neural_networks.layers import Layer
from si.src.neural_networks.losses import LossFunction, MeanSquaredError
from si.src.neural_networks.optimizers import Optimizer, SGD
...
if __name__ == '__main__':
    ...
    from si.src.neural_networks.activation import TanhActivation, SoftmaxActivation
    from si.src.neural_networks.losses import MeanSquaredError, CategoricalCrossEntropy
    from si.src.metrics.mse import mse
    from si.src.metrics.accuracy import accuracy
    from si.src.io.csv_file import read_csv

    # training data
    dataset = read_csv('si/datasets/iris/iris.csv', sep=',', features=True, label=True)
